 ...
 *
 * 	The resource server is located at "/mset", and can be accessed only by retrieving a token from "/oauth/token"
 *  using the Password Grant Flow as specified by OAuth 2.0.
 *  
 *  Most of this code can be reused in other applications. The key methods are:
 *  
 *  ResourceServer.configure(...) - this method is used to apply the appropriate 
 *  set of scope requirements on client requests
 *  
 *  OAuth2Config constructor - In this constructor "real" (not hard-coded) UserDetailsService
 *  and ClientDetailsService for authentication can be created. The current implementation 
 *  should never be used in any type of production environment as these hard-coded credentials 
 *  are highly insecure.
 *  
 *  OAuth2SecurityConfiguration.containerCustomizer(...) - this method should use a real keystore
...
public class OAuth2SecurityConfiguration {
	 ...
	 *	resource server (i.e. the "/mset" endpoint) 
	 */
	@Configuration
	...
	protected static class ResourceServer extends
		...
		// all of the paths in the mset service.
		@Override
		public void configure(HttpSecurity http) throws Exception {
			...
			// This is one of the key sections that need to be changed in a real app
	...
	protected static class OAuth2Config extends
		...
		public OAuth2Config() throws Exception {
			...
			// This is one of the key sections that need to be changed
			...
			ClientDetailsService csvc = new InMemoryClientDetailsServiceBuilder()
					...
					.scopes("read","write").resourceIds("mset")
					.and().build();
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
					Arrays.asList(
							...
							User.create("alicehouse", "pass", "USER"),
							User.create("charles_88", "pass", "USER"),
							User.create("alfonsor", "pass", "USER"),
							User.create("dugesia", "pass", "USER"),
							User.create("johnQ", "pass", "USER")));
